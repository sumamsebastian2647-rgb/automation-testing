...
class AssessmentPageScrom {
    constructor(page) {
        ...
        this.longqLink = page.locator('a[href="scorm-assessment"]');
    ...
    async createNewAssessment(assessmentData) {
        try {
            ...
            await this.page.waitForTimeout(1000);
            await this.page.locator('#assessments-upload_file').setInputFiles(config.samplescrom.sample);
...
module.exports = { AssessmentPageScrom };
