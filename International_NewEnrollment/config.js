...
const config = {
  ...
  generatelink: {
    ...
    autoacceptancelink1: 'https://rto2503.cloudemy.au/forms?u=274cd732',
    autoacceptancelink2: 'https://rto2503.cloudemy.au/forms?u=05064825',
  },
 ...
 /* courselist: {
  ...
  visa: {
    ...
    visaType: '1', // '1' for Student visa, '2' for Other visa
    visaTypeOther: '', // Only if visaType is '2'
    visaNumber: 'V123456789',
    visaCopyPath: 'test1.pdf',
    passportCopyPath: 'test2.pdf',
    whereVisa: 'Australia', // Only if holdAusVisa is false
    requireOSHC: '1', // '1' for Yes-Single, '2' for Yes-Couple, '3' for Yes-Family, '4' for No
    validOSHCPath: '', // Only if requireOSHC is '4'
    requireAirport: true,
  ...
  previousStudies: {
    studiedInAustralia: '1', // Yes
    transferFromAnother: '1', // Yes
    completeCourse: '0', // No
    transcriptPath: '',
    releaseLetter: '1', // Yes
    releaseLetterPath: 'test.pdf',
