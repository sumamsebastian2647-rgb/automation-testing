...
test.describe('@course Edit Course Module', () => {
  ...
  //validation for course code field - mandatory, no spaces allowed and max length
  ...
  //validation for spaces in course code field
  ...
  //max length validation for course code, name, avetmiss code and name fields
