...
// --- Login before each test ---
  ...
  // ───────────────────────────────
  test('Active dashboard - Category Name sorting @category @regression', async ({ page }) => {
  ...
  // ───────────────────────────────
  test('Active dashboard - Created Date sorting @category @regression', async ({ page }) => {
    await page.waitForSelector('.kv-grid-table', { state: 'visible' });
  ...
  // ───────────────────────────────
  test('Inactive dashboard - Category Name sorting @category @regression', async ({ page }) => {
  ...
  // ───────────────────────────────
  test('Inactive dashboard - Created Date sorting @category @regression', async ({ page }) => {
    await dashboardPage1.clickShowInactiveCategories();
    await page.waitForSelector('.kv-grid-table', { state: 'visible' });
